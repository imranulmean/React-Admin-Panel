! function(t) {
	...
	function n(e) {
		1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (t("body").removeAttr("data-bs-theme"), t("#dark-mode-switch").prop("checked", !1), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == t("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e && (t("#light-mode-switch").prop("checked", !1), t("body").attr("data-bs-theme", "dark"), sessionStorage.setItem("is_visited", "dark-mode-switch")), 1 == t("#rtl-mode-switch").prop("checked") ? (t("#bootstrap-style").attr("href", "assets/css/bootstrap-rtl.min.css"), t("#app-style").attr("href", "assets/css/app-rtl.min.css"), t("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch")) : (t("html").removeAttr("dir"), t("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"), t("#app-style").attr("href", "assets/css/app.min.css"))
	}
