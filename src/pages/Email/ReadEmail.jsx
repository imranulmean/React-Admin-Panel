                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="email-leftbar">
                                    <div class="d-grid">
                                        <Link to="/email-compose" class="btn btn-danger rounded waves-effect waves-light">Compose</Link>
                                    </div>
                                    ...
                                    <div class="card mt-4">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-5">
                                                <img class="me-3 rounded-circle avatar-sm" src="assets/images/users/avatar-1.jpg" alt="Generic placeholder image" />
                                                <div class="">
                                            ...
                                            <h4 class="mt-0 font-size-18">This Week's Top Stories</h4>
                                            ...
                                            <Link to="/compose-email" class="btn btn-secondary waves-effect mt-4"><i class="mdi mdi-reply"></i> Reply</Link>
                                        </div>
