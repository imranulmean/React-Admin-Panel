                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="email-leftbar">
                                    <div class="d-grid">
                                    <a href="email-compose.html" class="btn btn-danger rounded  waves-effect waves-light">Compose</a>
                                    </div>
                                    ...
                                    <div class="mail-list mt-3">
                                        <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-info float-end mt-1 ms-2"></span>Theme Support</a>
                                        <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-warning float-end mt-1 ms-2"></span>Freelance</a>
                                        <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-purple float-end mt-1 ms-2"></span>Social</a>
                                        <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-pink float-end mt-1 ms-2"></span>Friends</a>
                                    ...
                                    <div class="card mt-4">
                                        <ul class="message-list">
                                            ...
                                            <li>
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject"><span class="bg-purple badge me-2">Social</span>This Week's Top Stories – 
                                            ...
                                            <li>
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject"><span class="bg-pink badge me-2">Friends</span>Weekend on Revibe – 
                                            ...
                                            <li>
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject"><span class="bg-purple badge me-2">Social</span>Task assigned: Clone ARP's website
